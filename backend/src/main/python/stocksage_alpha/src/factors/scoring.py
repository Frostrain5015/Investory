...
class FactorWeights:
    ...
    value:          float = 0.5    # IC=None (no data)
    growth:         float = 0.3    # IC=+0.006, noise
    momentum:       float = 0.2    # IC=-0.057, ICIR=-0.34; too weak to invert
    quality:        float = 0.3    # IC=-0.040, ICIR=-0.39; weakened, zeroed
    # ── Core 3 ext-original ───────────────────────────────────────────────
